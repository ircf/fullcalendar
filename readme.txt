...
* By default **FullCalendar 3.4.0** JS+CSS is loaded from cdnjs, your can override it by setting the HEAD template (**WARNING** : Setting the HEAD template will remove the default FullCalendar JS+CSS loading)
